...
const Wallet = () => {
  ...
  const paymentId = query.get("payment_intent"); //query.get("payment_intent");
  ...
  }, [paymentId, orderId,razorpayPaymentId, dispatch, navigate, order_id]);

  useEffect(() => {
    handleFetchUserWallet();
    hanldeFetchWalletTransactions();
    dispatch(getPaymentDetails({ jwt: localStorage.getItem("token") }));
  }, []);

  const handleFetchUserWallet = () => {
    dispatch(getUserWallet(localStorage.getItem("token")));
  };

  const hanldeFetchWalletTransactions = () => {
    dispatch(getWalletTransactions({ jwt: localStorage.getItem("token") }));
  };
