...
const Profile = () => {
  ...
  const handleEnableTwoStepVerification =(otp)=>{
    ...
    dispatch(enableTwoStepAuthentication({jwt:localStorage.getItem("token"),otp}))
  }

  const handleVerifyOtp=(otp)=>{
    console.log("otp  - ",otp)
    dispatch(verifyOtp({jwt:localStorage.getItem("token"),otp}))
  }
  return (
            ...
            <div className="lg:flex gap-32">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"code with sha1"} </p>
                </div>
                <div className="flex">
